...
export default class SeniorNewReading extends Component {
  _isMounted = false;
  ...
  VitalsReadingsScreen() {
    // return <Temperature />;
    this.props.navigation.navigate('seniorVitalsReadings');
  }

  BloodPressureScreen() {
    this.props.navigation.navigate('seniorBloodPressureW');
  }

  BloodGlucoseScreen() {
    // return <Spo2 />;
    this.props.navigation.navigate('seniorBloodGlucose');
  }

  WeightScreen() {
    // return <Temperature />;
    this.props.navigation.navigate('seniorWeight');
  }


  HeightScreen() {
    // return <Temperature />;
    this.props.navigation.navigate('seniorHeight');
  }
